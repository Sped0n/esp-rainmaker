 ...
 *
 * The caller owns the returned list and must destroy it with app_rmaker_device_list_copy_destroy(). Returns NULL if no
 * successful device-list update has been received yet or memory allocation fails.
 */
