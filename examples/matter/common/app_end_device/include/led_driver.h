...
/**
 * @brief Initialize the LED driver from board/example configuration.
 */
led_driver_handle_t led_driver_init(led_driver_config_t *config);

/**
 * @brief Apply On/Off state. Other setters update level/color attributes without changing power state.
 */
