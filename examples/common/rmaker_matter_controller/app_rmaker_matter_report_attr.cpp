                                      ...
                                      uint32_t attribute_id, const cJSON *value)
{
    ...
    if (app_rmaker_matter_report_json_update_tree_item(ns->root, endpoint_id, cluster_id, attribute_id, value)) {
        if (app_rmaker_matter_report_json_merge_pending_attr_item(&s_pending_attr_delta, ns->node_id,
